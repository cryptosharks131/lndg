...
import { updateInboundFees } from "@/lib/channel-actions"
...
export function InboundFeesForm({ channel }: { channel: Channel }) {

    const [state, action, pending] = useActionState(updateInboundFees, {
        success: false,
        message: "",
        errors: {},
        inputs: { chanId: channel.chan_id, baseFee: channel.local_inbound_base_fee, feeRate: channel.local_inbound_fee_rate }, // Initialize inputs with default values
    });
