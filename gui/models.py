...
class Channels(models.Model):
    ...
    local_cltv = models.IntegerField(default=40)
    local_min_htlc_msat = models.BigIntegerField(default=0)
    local_max_htlc_msat = models.BigIntegerField(default=0)
    remote_base_fee = models.IntegerField(default=0)
    remote_fee_rate = models.IntegerField(default=0)
    remote_disabled = models.BooleanField(default=False)
    remote_cltv = models.IntegerField(default=40)
    remote_min_htlc_msat = models.BigIntegerField(default=0)
    remote_max_htlc_msat = models.BigIntegerField(default=0)
