...
1. Run `bitcoind`
2. Run `lnd`
3. Build required python file for your system to interact with lnd grpc (`rpc` + `router`), instructions can be found [here](https://github.com/lightningnetwork/lnd/blob/master/docs/grpc/python.md#setup-and-installation).  
  NOTE! The name of the `rpc` proto file has since been change in the lnd github to the `lightning` proto file and thus new compilations of this file will need to be renamed.
5. Clone respository
